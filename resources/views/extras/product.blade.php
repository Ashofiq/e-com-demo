<section class="section block-trending-now">
    <div class="container"> 
      ...
      <div class="row"> 
        ...
        <div class="col-lg-3 col-md-4 col-sm-6"> 
          <div class="cardProductStyle3 cardProductType03 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            <div class="cardImage">
              <a href="#">
              <img class="imageMain" src="{{$product['image']}}" alt="{{$product['name']}}">
              <img class="imageHover" src="{{$product['image']}}" alt="{{$product['name']}}"></a>
              <div class="button-select"><a href="#">Details Product </a></div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6"> 
          <div class="cardProduct wow fadeInUp">
            ...
            <div class="cardInfo"><a href="#">
                <h6 class="text-16-medium cardTitle">{{$product['name']}} </h6></a>
              <p class="body-p2 cardDesc">
                @if(isset($product['skus']))
                    {{$product['skus'][0]['price']}} {{ $config->currency_symbol }} 
                    
                    @if (count($product['skus']) > 1)
                    -
                      {{$product['skus'][count($product['skus']) - 1]['price']}} {{ $config->currency_symbol }} 
                    @endif
                @endif
      ...
      <div class="text-center wow fadeInUp">  <a class="btn btn-black" href="#">See All Products </a></div>
    </div>
  </section>
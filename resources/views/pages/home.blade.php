                        ...
                        <div class="container herobannerarea__slider  slider__default__arrow slider__default__dot">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 herobanner__img__side">
                                        <div class="herobanner__img">
                                            <img src="{{asset('/')}}frontend/img/herobanner/main_herobanner__2.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="herobannerarea__slider__single">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 herobanner__img__side">
                                        <div class="herobanner__img">
                                            <img src="{{asset('/')}}frontend/img/herobanner/main_herobanner__1.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="herobannerarea__slider__single">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 herobanner__img__side">
                                        <div class="herobanner__img">
                                            <img src="{{asset('/')}}frontend/img/herobanner/main_herobanner__3.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                        <div class="banner__img">
                            <img src="{{asset('/')}}frontend/img/banner/banner__1.png" alt="" />
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                        <div class="banner__img">
                            <img src="{{asset('/')}}frontend/img/banner/banner__2.png" alt="" />
                            <div class="banner__info">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__9.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__10.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__11.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__12.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__14.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__13.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__15.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__16.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__17.png" alt="Primary Image" />
                                    ...
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                ...
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__20.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__21.png" alt="Primary Image" />
                                    ...
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                ...
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__24.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__25.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__26.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__27.png" alt="Primary Image" />
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__29.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__30.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        <div class="grid__wraper__img__inner">
                                            <a href='single-product.html'>
                                                <img class="primary__image" src="{{asset('/')}}frontend/img/grid/grid__31.png" alt="Primary Image" />
                                                <img class="secondary__image" src="{{asset('/')}}frontend/img/grid/grid__32.png" alt="Secondary Image" />
                                            </a>
                                        </div>
                                        <div class="grid__wraper__icon">                                
                                            <ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <div class="cowndown__banner__inner">
                                <div class="cowndown__banner__title">
                                    <h2>Best Offer - Up __  <span>50% </span></h2>
                                </div>
                                <p>Explore our latest New ________ &amp; unlock discounts of __ to 50% off! </p>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <div class="cowndown__banner__img">
                                <img src="{{asset('/')}}frontend/img/banner/banner__3.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container-fluid full__width__padding">
                            <div class="animate__content__wrap">
                                ...
                                <div class="animate__content__single animate__content__single--2">
                                    <span>  Free return ________ </span>
                                </div>
                                <div class="animate__content__single">
                                    <span> No restocking fee </span>
                                </div>
                                <div class="animate__content__single animate__content__single--2">
                                    <span> No final sale _____ </span>
                                </div>
                                <div class="animate__content__single">
                                    <span>  100% Payment ______  </span>
                                </div>
                                <div class="animate__content__single animate__content__single--2">
...
<div class="container">
    <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <div class="feature__2__single">
                <div class="feature__2__icon">
                    <img src="{{asset('/')}}frontend/img/feature/feature__1.svg" alt="" />
                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <div class="feature__2__single">
                <div class="feature__2__icon">
                    <img src="{{asset('/')}}frontend/img/feature/feature__2.svg" alt="" />
                </div>
                <div class="feature__2__text">
                    <h4>Money Back </h4>
                    <p>Money back in 15 ____.. </p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <div class="feature__2__single">
                <div class="feature__2__icon">
                    <img src="{{asset('/')}}frontend/img/feature/feature__3.svg" alt="" />
                </div>
                <div class="feature__2__text">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <div class="feature__2__single">
                <div class="feature__2__icon">
                    <img src="{{asset('/')}}frontend/img/feature/feature__4.svg" alt="" />
                </div>
                <div class="feature__2__text">
    ...
    <div class="row row__custom__class instagram__slider__active slider__default__arrow slider__default__arrow slider__default__arrow--2">
        ...
        <div class="col-sm-12 column__custom__class">
            <div class="instagram__img">
                <a class="popup__img" href="{{asset('/')}}frontend/img/instagram/gallery-1.jpg">  <img src="{{asset('/')}}frontend/img/instagram/gallery-1.jpg" alt="Instagram Gallery Image" /></a>
             </div>
        </div>

        <div class="col-sm-12 column__custom__class">
            <div class="instagram__img">
                <a class="popup__img" href="{{asset('/')}}frontend/img/instagram/gallery-2.jpg">  <img src="{{asset('/')}}frontend/img/instagram/gallery-2.jpg" alt="Instagram Gallery Image" /></a>
             </div>
        </div>

        <div class="col-sm-12 column__custom__class">
            <div class="instagram__img">
                <a class="popup__img" href="{{asset('/')}}frontend/img/instagram/gallery-3.jpg">  <img src="{{asset('/')}}frontend/img/instagram/gallery-3.jpg" alt="Instagram Gallery Image" /></a>
             </div>
        </div>

        <div class="col-sm-12 column__custom__class">
            <div class="instagram__img">
                <a class="popup__img" href="{{asset('/')}}frontend/img/instagram/gallery-4.jpg">  <img src="{{asset('/')}}frontend/img/instagram/gallery-4.jpg" alt="Instagram Gallery Image" /></a>
             </div>
        </div>

        <div class="col-sm-12 column__custom__class">
            <div class="instagram__img">
                <a class="popup__img" href="{{asset('/')}}frontend/img/instagram/gallery-6.jpg">  <img src="{{asset('/')}}frontend/img/instagram/gallery-6.jpg" alt="Instagram Gallery Image" /></a>
             </div>
        </div>

        <div class="col-sm-12 column__custom__class">
            <div class="instagram__img">
                <a class="popup__img" href="{{asset('/')}}frontend/img/instagram/gallery-7.jpg">  <img src="{{asset('/')}}frontend/img/instagram/gallery-7.jpg" alt="Instagram Gallery Image" /></a>
             </div>
        </div>
